...
import com.sakura.chart.databinding.AppLayoutLoadProgressStyleNetBinding
import com.sakura.chart.v2.base.dialog.ArchDialog
...
class SimpleLoadingDialog(private val ui: IUIContext) :
     ...
     */
    fun bindLoadingEvent(ld: LiveData<XpxLoadingProgress>) {
        ld.observe(ui) {
            when (it.event) {
